...
Analyze a Cypress test failure to determine root cause and recommend a fix. This skill is used by the `/cypress:test-iteration:iterate-incident-tests` orchestrator but can also be invoked standalone.
