...
type Client interface {
	...
	// routing to the appropriate path internally. A nil value or a pointer to an empty
	// string signals "drop this label"; a pointer to a non-empty string sets the value.
	// Returns the (possibly new) rule ID.
