...
func TestDeleteAlertRuleById_NotFoundInRelabeledRules(t *testing.T) {
	...
	err := client.DeleteAlertRuleById(context.Background(), "nonexistent-id")
	if err == nil {
...
func TestDeleteAlertRuleById_PlatformRuleNotOperatorManaged(t *testing.T) {
	mockK8s := &testutils.MockClient{}
	mockK8s.RelabeledRulesFunc = func() k8s.RelabeledRulesInterface {
		return &testutils.MockRelabeledRulesInterface{
	...
	if err := newDeleteClient(mockK8s).DeleteAlertRuleById(context.Background(), deletePlatformRuleId); err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
}

func TestDeleteAlertRuleById_PlatformRuleGitOpsManaged(t *testing.T) {
	mockK8s := &testutils.MockClient{}
	mockK8s.RelabeledRulesFunc = func() k8s.RelabeledRulesInterface {
		return &testutils.MockRelabeledRulesInterface{
			GetFunc: func(_ context.Context, id string) (monitoringv1.Rule, bool) {
...
func TestDeleteAlertRuleById_PlatformRuleOperatorManaged(t *testing.T) {
	mockK8s := &testutils.MockClient{}
	mockK8s.RelabeledRulesFunc = func() k8s.RelabeledRulesInterface {
		return &testutils.MockRelabeledRulesInterface{
			GetFunc: func(_ context.Context, id string) (monitoringv1.Rule, bool) {
...
func TestDeleteAlertRuleById_PrometheusRuleNotFound(t *testing.T) {
	...
	err := newDeleteClient(mockK8s).DeleteAlertRuleById(context.Background(), deleteUserRule1Id)
	if err == nil {
...
func TestDeleteAlertRuleById_PrometheusRuleGetError(t *testing.T) {
	mockK8s := &testutils.MockClient{}
	mockK8s.RelabeledRulesFunc = func() k8s.RelabeledRulesInterface {
		return &testutils.MockRelabeledRulesInterface{
			GetFunc: func(_ context.Context, id string) (monitoringv1.Rule, bool) {
...
func TestDeleteAlertRuleById_RuleNotInPrometheusRule(t *testing.T) {
	mockK8s := &testutils.MockClient{}
	mockK8s.RelabeledRulesFunc = func() k8s.RelabeledRulesInterface {
		return &testutils.MockRelabeledRulesInterface{
			GetFunc: func(_ context.Context, id string) (monitoringv1.Rule, bool) {
...
func TestDeleteAlertRuleById_DeletesEntirePrometheusRule(t *testing.T) {
	...
	if err := newDeleteClient(mockK8s).DeleteAlertRuleById(context.Background(), deleteUserRule1Id); err != nil {
...
func TestDeleteAlertRuleById_UpdatesRemainingRules(t *testing.T) {
...
func TestDeleteAlertRuleById_RemovesEmptyGroup(t *testing.T) {
