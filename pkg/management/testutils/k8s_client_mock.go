...
// Each accessor lazily initializes a single backing mock so that
// write-then-read sequences (e.g. AlertingRules().Create followed
...
type MockClient struct {
	...
	alertRelabelConfigs k8s.AlertRelabelConfigInterface
...
func (m *MockClient) PrometheusRules() k8s.PrometheusRuleInterface {
	...
	if m.prometheusRules == nil {
		m.prometheusRules = &MockPrometheusRuleInterface{}
	}
...
func (m *MockClient) AlertRelabelConfigs() k8s.AlertRelabelConfigInterface {
	...
	if m.alertRelabelConfigs == nil {
		m.alertRelabelConfigs = &MockAlertRelabelConfigInterface{}
	}
	return m.alertRelabelConfigs
}
...
func (m *MockClient) AlertingRules() k8s.AlertingRuleInterface {
	...
	if m.alertingRules == nil {
		m.alertingRules = &MockAlertingRuleInterface{}
	}
...
func (m *MockClient) RelabeledRules() k8s.RelabeledRulesInterface {
	...
	if m.relabeledRules == nil {
		m.relabeledRules = &MockRelabeledRulesInterface{}
	}
	return m.relabeledRules
}
...
func (m *MockClient) Namespace() k8s.NamespaceInterface {
	...
	if m.namespace == nil {
		m.namespace = &MockNamespaceInterface{}
	}
	return m.namespace
}
