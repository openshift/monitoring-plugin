...
func TestCreatePlatformAlertRule_MixedCaseSeverity(t *testing.T) {
			...
			mockK8s := &testutils.MockClient{
				...
				AlertingRulesFunc: func() k8s.AlertingRuleInterface {
					return &testutils.MockAlertingRuleInterface{
						...
						CreateFunc: func(_ context.Context, _ osmv1.AlertingRule) (*osmv1.AlertingRule, error) {
							return &osmv1.AlertingRule{}, nil
						},
					}
				},
			}
