...
- Uses fixture: `incidents/scenarios/12-charts-ui-comprehensive.yaml` (includes very short duration incidents)
...
- Uses fixture: `incidents/scenarios/9-silenced-alerts-mixed-scenario.yaml`
