...
export const metricsPage = {
  ...
  clickActions: () => {
    ...
    cy.wait(3000);
    cy.get(`[id^="pf-dropdown-toggle-id"]`).contains('Actions').should('be.visible').click({force: true});
  ...
  clickActionsDeleteAllQueries: () => {
    ...
    metricsPage.clickActions();
    cy.byPFRole('menuitem').contains('Delete all queries').should('be.visible').click();
