...
> = {
  [RequirementGroupVersionKind.ClusterServiceVersion]: [[], true, null],
  [RequirementGroupVersionKind.UIPlugin]: [[], true, null],
  [RequirementGroupVersionKind.Alertmanager]: [[], true, null],
  [RequirementGroupVersionKind.MonitoringStack]: [[], true, null],
  [RequirementGroupVersionKind.Prometheus]: [[], true, null],
  [RequirementGroupVersionKind.LokiStack]: [[], true, null],
  [RequirementGroupVersionKind.ClusterLogForwarder]: [[], true, null],
  [RequirementGroupVersionKind.TempoStack]: [[], true, null],
  [RequirementGroupVersionKind.OpenTelemetryCollector]: [[], true, null],
  [RequirementGroupVersionKind.FlowCollector]: [[], true, null],
};
