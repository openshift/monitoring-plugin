...
const THRESHOLDS = {
  INCIDENTS_CHART_100_ALERTS: 2_500,
  INCIDENTS_CHART_200_ALERTS: 3_000,
  INCIDENTS_CHART_500_ALERTS: 3_000,
  INCIDENTS_CHART_1000_ALERTS: 60_000,

  ALERTS_CHART_100_ALERTS: 3_000,
  ALERTS_CHART_200_ALERTS: 5_000,
  ALERTS_CHART_500_ALERTS: 15_000,
  ALERTS_CHART_1000_ALERTS: 60_000,

  INCIDENTS_CHART_20_INCIDENTS: 2_500,
  INCIDENTS_CHART_MIXED_12: 2_500,
};
...
describe(
  ...
  { tags: ['@incidents', '@performance', '@regression'] },
  () => {
    before(() => {
