...
const CooAlertsPage = lazy(() =>
  import(/* webpackChunkName: "CooAlertsPage" */ './alerts-page/AlertsPage').then((module) => ({
    default: module.McpAcmAlertsPage,
  })),
);
const CmoSilencesPage = lazy(() =>
  import(/* webpackChunkName: "CmoSilencesPage" */ './silences-page/SilencesPage').then(
    (module) => ({
...
const CooSilencesPage = lazy(() =>
  import(/* webpackChunkName: "CooSilencesPage" */ './silences-page/SilencesPage').then(
    (module) => ({
...
const CmoAlertRulesPage = lazy(() =>
  import(/* webpackChunkName: "CmoAlertRulesPage" */ './alert-rules-page/AlertRulesPage').then(
    (module) => ({
...
const CooAlertRulesPage = lazy(() =>
  import(/* webpackChunkName: "CooAlertRulesPage" */ './alert-rules-page/AlertRulesPage').then(
    (module) => ({
