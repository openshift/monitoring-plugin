...
import { CreateSilencesPage as dataTest } from '../data-test';
  ...
  return (
    <>
      ...
      <PageSection hasBodyWrapper={false}>
        ...
        <HelperText>
          <HelperTextItem data-test={dataTest.Description}>
            {t(
        ...
        <Form onSubmit={onSubmit} maxWidth="950px">
          ...
          <Grid hasGutter>
            <GridItem sm={4} md={5}>
              <FormGroup label={t('Silence alert from...')}>
                {isStartNow ? (
                  <DatetimeTextInput
                    isDisabled
                    data-test={dataTest.SilenceFrom}
                    value={t('Now')}
                ...
                <Select
                  ...
                  toggle={(toggleRef: React.Ref<MenuToggleElement>) => (
                    <MenuToggle
                      ...
                      isExpanded={isOpen}
                      isFullWidth
                      data-test={dataTest.SilenceForToggle}
                    >
                      {duration}
                    </MenuToggle>
                  )}
            ...
            <GridItem sm={4} md={5}>
              <FormGroup label={t('Until...')}>
                {duration === durationOff ? (
                  <DatetimeTextInput
                    data-test={dataTest.SilenceUntil}
                    isRequired
          ...
          <FormGroup role="group">
            <Checkbox
              ...
              data-test={dataTest.StartImmediately}
            />
          </FormGroup>
          ...
          <FormHelperText>
            <HelperText>
              <HelperTextItem variant="indeterminate" data-test={dataTest.AlertLabelsDescription}>
                <Trans t={t}>
                ...
                <FormGroup isInline label={t('Select all that apply:')}>
                  <FormGroup role="group" isInline style={{ marginTop: t_global_spacer_sm.var }}>
                    ...
                    <Tooltip content={<NegativeMatcherHelp />}>
                      <Checkbox
                        ...
                        data-test={dataTest.NegativeMatcherCheckbox}
                      />
                    </Tooltip>
                  </FormGroup>
                  <Tooltip content={t('Remove')}>
                    <Button
                      ...
                      variant="plain"
                      isInline
                      data-test={dataTest.RemoveLabel}
                    />
                  </Tooltip>
                </FormGroup>
              </GridItem>
          ...
          <ActionGroup>
            <Button
              ...
              data-test={dataTest.SilenceButton}
            >
              {t('Silence')}
            </Button>
            <Button
              ...
              variant="secondary"
              isDisabled={inProgress}
              data-test={dataTest.CancelButton}
            >
              {t('Cancel')}
            </Button>
          </ActionGroup>
