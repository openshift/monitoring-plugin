...
export const LegacyDashboardPageTestIDs = {
  TimeRangeDropdown: 'monitoring-time-range-dropdown-dropdown', //#id
  TimeRangeDropdownOptions: 'time-range-dropdown-options',
  PollIntervalDropdown: 'refresh-interval-dropdown-dropdown', //#id
...
export const Classes = {
  ...
  DashboardHeaderDropdownMenu: '.pf-v5-c-menu__list', //menu using get('.pf-v5-c-menu__list')
  DashboardDropdown: '.monitoring-dashboards__variable-dropdown',
  DashboardDropdownField: '.pf-v5-c-select__toggle-text',
  ...
  MenuItem: '.pf-v6-c-menu__item, .pf-c-dropdown__menu-item, .pf-v5-c-menu__item',
  ...
  MetricsPageNoDatapointsFoundTableMessage: '.query-browser__table-message',
  MetricsPageQueryInput: '.cm-content.cm-lineWrapping',
  MetricsPageUngraphableResults: '.pf-v6-c-title.pf-m-md, .pf-v5-c-title.pf-m-md',
  MetricsPageUngraphableResultsDescription:
    '.pf-v6-c-empty-state__body, .pf-v5-c-empty-state__body',
  MetricsPageUnselectedAllButton:
    '.pf-v5-c-button.pf-m-link.pf-m-inline.query-browser__series-select-all-btn',
