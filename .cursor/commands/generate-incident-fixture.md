...
Create fixture following the schema in [fixture-schema.json](mdc:web/cypress/support/incidents/schema/fixture-schema.json). Prefer this schema over existing fixtures.
...
- run the validation using [validate-fixtures.ts](mdc:web/cypress/support/incidents/schema/validate-fixtures.ts)
...
- [ ] Schema validation passes against [fixture-schema.json](mdc:web/cypress/support/incidents/schema/fixture-schema.json)
