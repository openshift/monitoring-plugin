...
```typescript
const hoverAndVerifyTooltipPosition = (
  barIndex: number,
...
const verifyAlertSilenceIndicator = (
  ...
  tooltip.should(
    isSilenced ? "contain.text" : "not.contain.text",
    "(silenced)",
  );
};
