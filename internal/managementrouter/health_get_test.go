...
func (s *stubClient) DeleteAlertRuleById(_ context.Context, _ string) error { return nil }
func (s *stubClient) UpdatePlatformAlertRule(_ context.Context, _ string, _ monitoringv1.Rule) error {
	return nil
}
func (s *stubClient) DropAlertRule(_ context.Context, _ string) error    { return nil }
func (s *stubClient) RestoreAlertRule(_ context.Context, _ string) error { return nil }
